...
class DDPG_1(BaseAlgo):
    
    _epoch: int

    def _init_env(self) -> None:
   
        self._env: OffPolicyAdapter_1 = OffPolicyAdapter_1(
            self._env_id,
    ...
    def _init(self) -> None:
        ...
        self._buf: VectorOffPolicyBuffer_1 = VectorOffPolicyBuffer_1(
            obs_space=self._env.observation_space,
            act_space=self._env.action_space,
    ...
    def _update(self) -> None:
        ...
        for _ in range(self._cfgs.algo_cfgs.update_iters):
            ...
            if self._cfgs.algo_cfgs.use_cost:
                ...
                self._update_cost_critic(obs, act, cost, done, next_obs, env_id, env_step)
