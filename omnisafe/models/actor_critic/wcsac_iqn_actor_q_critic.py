...
# ==============================================================================
"""Actor-critic container for WCSAC-IQN."""
...
class WCSACIQNActorQCritic(ActorQCritic):
    """SAC actor/reward critics with one IQN cost critic."""
    ...
    def __init__(
        ...
        """Initialize reward and distributional cost networks."""
        ...
        self.cost_critic = IQNCostCritic(
            ...
            embedding_dim=model_cfgs.critic.get('iqn_embedding_dim', 64),
        )
    ...
    def polyak_update(self, tau: float) -> None:
        """Update reward, actor, and IQN target networks."""
