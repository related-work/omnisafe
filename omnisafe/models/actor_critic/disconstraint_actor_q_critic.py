...
from omnisafe.models.critic.dis_critic_builder import DisCriticBuilder
from omnisafe.typing import OmnisafeSpace
from omnisafe.utils.config import ModelConfig


class DisConstraintActorQCritic(ActorQCritic):
    ...
    def __init__(
        ...
        self.cost_critic: Critic = DisCriticBuilder(
            obs_space=obs_space,
            act_space=act_space,
